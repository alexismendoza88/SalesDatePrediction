...
public partial class DataContext : DbContext
{
    ...
    public virtual DbSet<NextPredictedOrder> NextPredictedOrders { get; set; }//query

    //protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    //    => optionsBuilder.UseSqlServer("Server=.;Database=StoreSample;Trusted_Connection=True;Trust Server Certificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NextPredictedOrder>(entity =>
        {
            entity
                .HasNoKey();
            entity.Property(e => e.Custid).HasColumnName("Custid");
            entity.Property(e => e.CustomerName)
                  .HasColumnType("varhar").HasMaxLength(50)
                  .HasColumnName("customerName");
            entity.Property(e => e.NextPredictedOrderDate)
             .HasColumnType("datetime")
             .HasColumnName("nextPredictedOrderDate");
